...
socket.on("admin_receive_message", (data) => {
  const connections = connectionsUsers.find(connection => connection.socket_id = data.socket_id);
  const divMessages = document.getElementById(`allMessages${connections.user_id}`);
  const createDiv = document.createElement("div")
